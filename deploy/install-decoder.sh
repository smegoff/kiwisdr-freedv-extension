...
install -d -m 0755 /usr/local/share/freedv-dashboard/0.1.22
install -m 0644 "$src/dashboard/index.html" "$src/dashboard/app.js" \
  "$src/dashboard/styles.css" /usr/local/share/freedv-dashboard/0.1.22/
ln -sfn 0.1.22 /usr/local/share/freedv-dashboard/current
