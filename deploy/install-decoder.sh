...
echo "Management diagnostics use TCP 8076; enforce the example firewall policy."
echo "The disabled public spectator listener uses loopback TCP 8077 and requires a separate HTTPS edge."
