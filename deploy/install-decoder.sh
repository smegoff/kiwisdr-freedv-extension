...
install -d -m 0755 /usr/local/share/freedv-dashboard/0.1.35
install -m 0644 "$src/dashboard/index.html" "$src/dashboard/app.js" \
  "$src/dashboard/styles.css" /usr/local/share/freedv-dashboard/0.1.35/
ln -sfn 0.1.35 /usr/local/share/freedv-dashboard/current
