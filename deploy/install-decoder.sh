...
install -d -m 0755 /usr/local/share/freedv-dashboard/0.1.33
install -m 0644 "$src/dashboard/index.html" "$src/dashboard/app.js" \
  "$src/dashboard/styles.css" /usr/local/share/freedv-dashboard/0.1.33/
ln -sfn 0.1.33 /usr/local/share/freedv-dashboard/current
