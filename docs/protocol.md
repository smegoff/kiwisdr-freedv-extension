...
`127.0.0.1:8077` with a 16-viewer WebSocket ceiling. HTTPS, source-address rate
limits and internet ingress remain the responsibility of a separate reverse
proxy; see [public-dashboard.md](public-dashboard.md).
