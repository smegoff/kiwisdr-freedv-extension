...
written for Kiwi extension `0.1.33`, decoder service `0.1.25`, and KiwiSDR
...
for example `deploy-decoder-release.sh /opt/kiwi-freedv-v0-1-25 v0.1.25 0.1.25`.
...
3. With RADEV1 still disabled, select 700D and press **Test 700D**. Require
   ...
   cadence, while decoder v0.1.25 emits receiver-sized packets from a bounded
