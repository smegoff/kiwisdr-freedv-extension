...
For the reference deployment, the Kiwi release is `freedv-v0-1-19`, the
immediate Kiwi rollback is `freedv-v0-1-16`, the decoder guest runs `0.1.18`,
...
immediate `freedv-v0-1-16` Kiwi release or run
